package com.qa.checkCreation.util;
...
import com.qa.checkCreation.ExtentReportsListeners.ExtentReportListener;
...
public class TestBase extends ExtentReportListener {
	...
	public TestBase() {
		try {
			prop = new Properties();
			FileInputStream fis = new FileInputStream("F:\\Selenium\\CheckCreationProcessAutomation\\src\\main\\java\\com\\qa\\checkCreation\\config\\config.properties");
			prop.load(fis);
		} catch(IOException e) {
			e.getMessage();
		}
