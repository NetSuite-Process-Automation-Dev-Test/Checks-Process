package com.qa.checkCreation.ExtentReportsListeners;
...
public class ExtentReportListener {
	...
	public static ExtentReports setUp() {
		...
		report = new ExtentSparkReporter(System.getProperty("user.dir") + "/Extent_report/Check Creation Process Automation.html");
		report.config().setDocumentTitle("Check Creation Process Automation"); // Tile of report
		report.config().setReportName("Check Creation Process Automation"); // Name of the report
