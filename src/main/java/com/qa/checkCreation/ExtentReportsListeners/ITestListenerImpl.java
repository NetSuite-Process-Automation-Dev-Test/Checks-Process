...
public class ITestListenerImpl extends ExtentReportListener implements ITestListener {
	...
	public void emailToSingleReceipient(String receipient) throws EmailException {
		...
		attachment.setPath("./Extent_report/Check Creation Process Automation.html");
		...
		email.setSubject("Check Creation Process Automation Test Report");
		email.setMsg("Hey, Automation testing for Check Creation is completed. Please find the test report below");
